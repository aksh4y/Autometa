...
import com.akshaysadarangani.autometa.services.GeofenceTransitionService;
...
//    private TextView textLat, textLong;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        userID = "TDA3sgDU2ZXT4GFxaCI7JX5ZBGY2";
  ...
  /*  @Override
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng triggerArea = new LatLng(22.5504046, 88.3804957);    // set to my location
        mMap.addCircle(new CircleOptions()
                ...
                .strokeWidth(5.0f));
        //0.5f = 0.5km = 500m
        GeoQuery geoQuery = geoFire.queryAtLocation(new GeoLocation(triggerArea.latitude, triggerArea.longitude), 0.5f);
        geoQuery.addGeoQueryEventListener(new GeoQueryEventListener() {
            @Override
            public void onKeyEntered(String key, GeoLocation location) {
                sendNotification("Autometa", String.format("%s entered the trigger area", key));
            }

            @Override
            public void onKeyExited(String key) {
                sendNotification("Autometa", String.format("%s exited the trigger area", key));
            }

            @Override
            public void onKeyMoved(String key, GeoLocation location) {
                Log.e(TAG, String.format("%s moved in the trigger area [%f/%f]", key, location.latitude, location.longitude));
            }
    ...
    private BroadcastReceiver br = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
           Log.e("MapActivity", "broadcast_receiver");
            // updateGUI(intent); // or whatever method used to update your GUI fields
        }
    };

    private void sendNotification(String title, final String content) {
